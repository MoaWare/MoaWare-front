...
function PaymentWaitBoardContext ({pay, pageInfo, setCurrentPage}) {
    ...
    const onClickDetailHandler = (e) => {
        ...
        navigate(`/pay/payWaitDetail/${e.target.getAttribute("value")}`)
    }
...
export default PaymentWaitBoardContext;