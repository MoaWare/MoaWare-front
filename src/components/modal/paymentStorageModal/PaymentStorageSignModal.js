...
import PaySignModalCSS from './PaymentStorageSignModal.module.css'
import { FiX } from 'react-icons/fi';

function PaymentStorageSignModal ({setPaymentSignModal, setImageForm}) {
...
export default PaymentStorageSignModal;