...
import orgCSS from './PayStorageOrgListModal.module.css';
import { payStorageContext } from '../../../pages/payment/PaymentStorageDetail';



function PayStorageOrgListModal({org , empCode}) {
                ...
                { org && org.map(org => !(org.refDeptCode)?  
                    (
                        <div key={org.deptCode} >
                            ...
                            {searchForm.isSearch? 
                            isOpen[org.deptCode]  && isOpen[org.deptCode] ? 
                            (org.orgEmp.map(emp => emp.empCode === empCode ? "":
                            ...
                            :
                             isOpen[org.deptCode]  && isOpen[org.deptCode] ? 
                                ...
                                <div key={sub.deptCode}>
                                    ...
                                    {isOpen[sub.deptCode]  && isOpen[sub.deptCode] ? 
                                        (sub.orgEmp.map(emp => emp.empCode === empCode ? "":
...
export default PayStorageOrgListModal;